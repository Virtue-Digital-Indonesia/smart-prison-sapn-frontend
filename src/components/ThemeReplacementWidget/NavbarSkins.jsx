...
const NavbarSkins = () => {
  ...
  const handleRadioGroupChange = (event) => {
    setAppTheme((prev) => ({ ...prev, navbarColor: event.target.value }))
    setSapnThemeToLocalStorage({ ...appTheme, navbarColor: event.target.value })
  }

  const handleCheckBoxChange = (event) => {
    setAppTheme((prev) => ({ ...prev, navBarInverse: event.target.checked }))
    setSapnThemeToLocalStorage({
      ...appTheme,
      navBarInverse: event.target.checked,
    })
  }
  ...
  return (
    ...
    >
      ...
      <>
        ...
        <FormControlLabel
          control={<Checkbox checked={appTheme.navBarInverse} size='small' />}
          label='Inverse'
